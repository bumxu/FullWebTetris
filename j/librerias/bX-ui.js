		...
		switch(id){
			case 0:
				if(!activeGame)
					break;
				fwt.setEvents();
				$('section#game').show().animate({ 'margin-left': 0 }, 500);
				$('section#main').animate({ 'margin-left': '-110%' }, 500, function () {
					$(this).hide();
					fwt.pause(0);
				});
			break;
			...
			case 2: // -> Customize
				...
				$('section:not(#settings)').animate({ 'margin-left': '-110%' }, 500, function() { $(this).hide(); });
				$('section#settings').show().animate({ 'margin-left': 0 }, 500);
			break;
			case 3: // -> Marks
				$('section:not(#marks)').animate({ 'margin-left': '-110%' }, 500, function() { $(this).hide(); });
				$('section#marks').show().animate({ 'margin-left': 0 }, 500);
			break;
			case 4: // -> Assistance
				fwt.pause(1);
				setEvents();

				$('section:not(#help)').animate({ 'margin-left': '-110%' }, 500, function() { $(this).hide(); });
				$('section#help').show().animate({ 'margin-left': 0 }, 500);
			break;
			case 6: // -> Back to main menu
				...
				$('section:not(#main)').animate({ 'margin-left': '110%' }, 500, function() { $(this).hide(); });
				$('section#main').show().animate({ 'margin-left': 0 }, 500);
			break;
