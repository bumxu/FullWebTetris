var HCI = function (fwt) {
	...
	{
		e 			=  e.originalEvent || e;
		uPageX 	=  e.pageX || e.changedTouches[0].pageX;   // Multibrowser pageX (fIE!)

		mOffset 	=  uPageX - $(this).children("#tiles").position().left;
	}
	...
	if (window.navigator.msPointerEnabled) {
		$("section#main #selector")[0].addEventListener("MSPointerDown", touchStartEvent, false);
		$("section#main #selector")[0].addEventListener("MSPointerMove", touchMoveEvent, false);
	}
	$("section#main #selector").bind("touchstart", touchStartEvent);
	$("section#main #selector").bind("touchmove", touchMoveEvent);
